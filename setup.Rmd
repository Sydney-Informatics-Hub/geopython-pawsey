...
Grab a copy from: https://github.com/Sydney-Informatics-Hub/geopython-pawsey/tree/main/_ipynb/data
...
This should install other key libraries e.g. ```numpy, matplotlib, pandas, pyshp``` as dependencies.
